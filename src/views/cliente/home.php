...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top shadow-sm">
  <div class="container">
    <a class="navbar-brand fw-bold" href="#inicio" style="display: flex;">
      <img src="/public/logo-pizza.png" alt="Logo" width="30" height="30" class="d-inline-block align-text-top me-2">
    ...
    <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
      ...
      <a href="/pizzeria/login" class="btn btn-outline-success d-flex align-items-center">
        <img src="/public/logo-admin.png" alt="Logo" width="25" height="25" class="me-2">
        Iniciar Sesión
      </a>
    </div>
  </div>
  ...
  <div id="carouselExampleCaptions" class="carousel slide mb-5">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="/public/pizza1.jpg" class="d-block w-100" style="height: 80vh; object-fit: cover;" alt="Pizza artesanal">
      ...
      <div class="carousel-item">
        <img src="/public/pizza2.jpg" class="d-block w-100" style="height: 80vh; object-fit: cover;" alt="Pizza familiar">
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <img src="/public/pizza3.jpg" class="d-block w-100" style="height: 80vh; object-fit: cover;" alt="Pizza gourmet">
        <div class="carousel-caption d-none d-md-block">
        ...
        <?php if ($producto['id_categoria'] == 1): ?>
          <div class="col">
            <div class="card h-100 shadow-sm border-0 rounded-4 overflow-hidden">
              <img src="/public/pizza1.jpg" class="card-img-top" alt="<?= htmlspecialchars($producto['nombre']) ?>">
        ...
        <?php if ($producto['id_categoria'] == 2): ?>
          <div class="col">
            <div class="card h-100 shadow-sm border-0 rounded-4 overflow-hidden" style="height: 360px;">
              <img src="/public/bebida.jpg" class="card-img-top" alt="<?= htmlspecialchars($producto['nombre']) ?>" style="height: 200px; object-fit: cover;">
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
      <?php foreach($productos as $producto): ?>
        <?php if ($producto['id_categoria'] == 3): ?>
          <div class="col">
            <div class="card h-100 shadow-sm border-0 rounded-4 overflow-hidden">
              <img src="/public/postre.jpg" class="card-img-top" alt="<?= htmlspecialchars($producto['nombre']) ?>">
              <div class="card-body text-center">
                <h5 class="card-title fw-bold"><?= htmlspecialchars($producto['nombre']) ?></h5>
                <p class="card-text text-muted small"><?= htmlspecialchars($producto['descripcion']) ?></p>
                <span class="badge bg-success fs-6">$<?= number_format($producto['precio'], 2) ?></span>
...
function mostrarCategoria(id) {
  ...
  document.querySelectorAll('.categoria').forEach(c => c.classList.add('d-none'));
  
  // Muestra la categoría seleccionada
  document.querySelector('.categoria-' + id).classList.remove('d-none');

  // Cambia el estado activo de los botones
  document.querySelectorAll('#productos button').forEach(b => b.classList.remove('active'));
